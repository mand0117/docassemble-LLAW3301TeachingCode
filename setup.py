...
setup(name='docassemble.LLAW3301TeachingCode',
      version='0.0.1',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/LLAW3301TeachingCode/', package='docassemble.LLAW3301TeachingCode'),
     )
